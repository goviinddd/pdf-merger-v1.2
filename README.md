...
🕵️‍♂️ The Sniper (YOLOv8): Visually detects and crops tables and PO numbers from PDFs with high precision.

🧠 The Brain (Gemini AI): Uses Google's Gemini 2.5 Flash to intelligently read complex, nested line items from tables.

⚖️ 3-Way Matching: Automatically reconciles Purchase Orders against Delivery Notes and Invoices.

🛡️ Safety Net: Prevents merging if items are missing, incomplete, or if "Ghost Matches" occur.
